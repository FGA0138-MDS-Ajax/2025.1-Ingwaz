     ...
     <>
        ...
        {selectedDay && (
            ...
            {carregandoDetalhe ? (
                ...
                <>
                <Text style={styles.detailText}>Temp. Máx: {selectedDay.temperature_2m_max}{selectedDay.units?.temperature_2m_max}</Text>
                <Text style={styles.detailText}>Temp. Mín: {selectedDay.temperature_2m_min}{selectedDay.units?.temperature_2m_min}</Text>
                <Text style={styles.detailText}>Precipitação: {selectedDay.precipitation_sum}{selectedDay.units?.precipitation_sum}</Text>
                <Text style={styles.detailText}>Vento: {selectedDay.windspeed_10m_max}{selectedDay.units?.windspeed_10m_max}</Text>
                </>
            )}
            </View>
        )}
